...
class CollectionViewController: UICollectionViewController {
    ...
    override func collectionView(collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        return _imageUrls.count*20;
    }
    
    override func collectionView(collectionView: UICollectionView, cellForItemAtIndexPath indexPath: NSIndexPath) -> UICollectionViewCell {
        var cell: CollectionViewCell = collectionView.dequeueReusableCellWithReuseIdentifier("PHOTO_CELL", forIndexPath: indexPath) as CollectionViewCell;
        cell.setup(_imageUrls[indexPath.row%_imageUrls.count]);
        return cell;
    }
